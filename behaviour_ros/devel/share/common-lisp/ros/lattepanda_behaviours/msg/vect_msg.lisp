...
(cl:in-package lattepanda_behaviours-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <vect_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'vect_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lattepanda_behaviours-msg:<vect_msg> is deprecated: use lattepanda_behaviours-msg:vect_msg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <vect_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lattepanda_behaviours-msg:header-val is deprecated.  Use lattepanda_behaviours-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <vect_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lattepanda_behaviours-msg:angle-val is deprecated.  Use lattepanda_behaviours-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <vect_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lattepanda_behaviours-msg:value-val is deprecated.  Use lattepanda_behaviours-msg:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<vect_msg>)))
  ...
  "lattepanda_behaviours/vect_msg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'vect_msg)))
  "Returns string type for a message object of type 'vect_msg"
  "lattepanda_behaviours/vect_msg")
