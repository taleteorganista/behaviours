...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  execute_process(COMMAND "/usr/bin/python3" -m compileall "/home/lattepanda/lattepanda_behaviours/behaviour_ros/devel/lib/python3/dist-packages/lattepanda_behaviours")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/python3/dist-packages" TYPE DIRECTORY FILES "/home/lattepanda/lattepanda_behaviours/behaviour_ros/devel/lib/python3/dist-packages/lattepanda_behaviours")
endif()
